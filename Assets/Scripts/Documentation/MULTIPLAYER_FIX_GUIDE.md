# Multiplayer Camera and Input System Fix Guide

This guide addresses the two critical multiplayer issues:
...
### Camera System
- Eye Player camera renders to output channel 1
- Hand Player camera renders to output channel 2
...
1. Check Cinemachine Camera priorities
2. Verify output channel assignments in inspector
